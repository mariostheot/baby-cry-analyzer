...
dependencies {
    ...
    // Branded launch experience (Android 12 splash API, backported to older versions).
    ...
    // Schedules the "why did the baby cry?" reminder a few minutes after a cry, even if the
    // app is backgrounded.
